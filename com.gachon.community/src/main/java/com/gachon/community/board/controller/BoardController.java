...
public class BoardController {
    ...
    @GetMapping("/{menuId}")
    public List<BoardResponse> getBoardLists(@PathVariable("menuId") Long menuId) {
    ...
    public BoardResponse getBoardItem(@PathVariable("menuId") Long menuId, @PathVariable("boardId") Long boardId) {
